...
//        tvDiscoverPageInfo = view.findViewById(R.id.tvDiscoverPageInfo)
    ...
    private fun setupOngoingNovels() {
        ...
        tvViewAllOngoing.setOnClickListener {
            // TODO: Navigate to full ongoing novels page
            Toast.makeText(requireContext(), "View all ongoing novels", Toast.LENGTH_SHORT).show()
        }
    }
    ...
    private fun setupCompletedNovels() {
        ...
        tvViewAllCompleted.setOnClickListener {
            // TODO: Navigate to full completed novels page
            Toast.makeText(requireContext(), "View all completed novels", Toast.LENGTH_SHORT).show()
        }
    }
