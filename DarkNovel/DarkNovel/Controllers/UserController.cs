...
namespace DarkNovel.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        public async Task<IActionResult> Login([FromBody] LoginRequest request)
        {
            ...
            var reader = _context.Readers.FirstOrDefault(r => r.UserId == user.Id);//DUYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYY
            ...
            return Ok(new
            {
                ...
                user.Username,
                user.Email,
                readerId = reader != null ? reader.Id : 0,//DUYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYY
                token = token
            });
        }
